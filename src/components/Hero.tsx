      ...
      <div className="container grid lg:grid-cols-2 mt-40 px-4 sm:px-8">
        ...
        <div className="hidden lg:flex justify-center items-center">
          <img 
            ...
            className="w-60 h-60 rounded-full shadow-lg object-cover border-4 border-purple-600 mb-96"
            data-aos="zoom-in"
          />
        </div>
        ...
        <div className="flex flex-col justify-center items-center text-center lg:text-left space-y-6 mt-20">
          <div className="text-[40px] sm:text-[60px] md:text-[80px] font-bold leading-tight">
            <p data-aos="zoom-in-down" className="text-red-500 italic text-[20px] sm:text-[30px] md:text-[40px] mt-10">
              I&apos;m
            </p>
            <p data-aos="zoom-in-down" className="text-purple-900 italic text-[20px] sm:text-[30px] md:text-[40px] mt-0">
              Muzammil
            </p>
            <p data-aos="zoom-in-down" className="text-[30px] sm:text-[50px] md:text-[70px] lg:text-[40px] mt-0">
              Shaheen
            </p>
            <p className="text-[20px] sm:text-[10px] md:text-[20px] lg:text-[20px] mt-10">
              A Web Developer, Maker, and Problem Solver
            </p>
            <p className="text-[20px] sm:text-[10px] md:text-[20px] lg:text-[20px] mt-0">
          ...
          <button
            ...
            className="px-4 py-2 bg-purple-600 text-white text-sm rounded-lg
             hover:bg-purple-700 shadow-lg transition-all mb-44"
          >
            Learn More
          </button>
        </div>
